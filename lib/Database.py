...
#slin 20180829  change parameters value: makeDBForFMIndexFromFASTA
...
#def makeDBForFMIndexFromFASTA(fastaFile, outFileBase, transformLtoI = True, seqSeperator='-', maxIndexSize = 2**26-2):
def makeDBForFMIndexFromFASTA(fastaFile, outFileBase, transformLtoI = True, seqSeperator='-', maxIndexSize = (2**31)-(2**30)):
